...
class InfoDriver extends StatefulWidget {
  @override
  _InfoDriverState createState() => _InfoDriverState();
}

class _InfoDriverState extends State<InfoDriver> {
  ...
  final DatabaseReference _databaseReference = FirebaseDatabase.instance.reference().child('drivers');
  ...
  Future<void> _saveDataToFirebase() async {
    if (_formKey.currentState!.validate() && _image != null) {
      try {
        ...
        String fileName = 'picturesD/${DateTime.now().millisecondsSinceEpoch.toString()}.jpg';
