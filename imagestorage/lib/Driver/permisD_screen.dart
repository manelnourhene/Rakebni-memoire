...
class PermisDScreen extends StatefulWidget {
  @override
  _PermisDScreenState createState() => _PermisDScreenState();
}

class _PermisDScreenState extends State<PermisDScreen> {
  ...
  final DatabaseReference _databaseReference = FirebaseDatabase.instance.reference().child('Permis_Driver');
  ...
  Future<void> _saveDataToFirebase() async {
    if (_formKey.currentState!.validate() && _frontImage != null && _backImage != null) {
      try {
        ...
        String frontFileName = 'PermisD/front_${DateTime.now().millisecondsSinceEpoch.toString()}.jpg';
        String backFileName = 'PermisD/back_${DateTime.now().millisecondsSinceEpoch.toString()}.jpg';
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              SizedBox(height: 16),
              Text('Front of driving license', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
              SizedBox(height: 8),
              GestureDetector(
              ...
              SizedBox(height: 16),
              Text('Back of the driving license', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
              SizedBox(height: 8),
              GestureDetector(
